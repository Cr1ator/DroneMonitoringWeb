  ...
  return (
    <>
      ...
      <div
        ...
        lg:max-h-[80vh] lg:md:max-h-[calc(100vh-6rem)]
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center space-x-2 md:space-x-3 text-xs tech-font">
                      <span className="text-green-400">
                        Макс:{" "}
                        {Math.max(...history.map((h) => h.altitude)).toFixed(0)}
                        м
                      </span>
                      <span className="text-blue-400">
                        Мин:{" "}
                        {Math.min(...history.map((h) => h.altitude)).toFixed(0)}
                        м
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center space-x-2 md:space-x-3 text-xs tech-font">
                      <span className="text-yellow-400">
                        Макс:{" "}
                        {Math.max(...history.map((h) => h.speed)).toFixed(1)}
                        м/с
                      </span>
                      <span className="text-orange-400">
                        Мин:{" "}
                        {Math.min(...history.map((h) => h.speed)).toFixed(1)}
                        м/с
                      </span>
                    </div>
                  </div>
                      ...
                      >
                        <div className="flex justify-between items-center flex-wrap gap-1">
                          ...
                          <div className="flex space-x-2 md:space-x-3 text-xs">
                            ...
                            <span
                              title="Курс"
                              className="text-blue-400 tech-font"
                            >
